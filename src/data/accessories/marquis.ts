...
export const marquisAccessories: AccessoryVendor = {
  ...
  products: [
    ...
    // Chemicals
    { id: 'mq-chlor-gran', name: 'Chlorine Granules 2lb', sku: 'CHM-CHL2', price: 14.95, category: 'Chemicals', unit: 'each' },
    { id: 'mq-test-strips', name: 'Test Strips 50ct', sku: 'CHM-TST50', price: 12.95, category: 'Chemicals', unit: 'box' },
    { id: 'mq-ph-down', name: 'pH Decreaser 2lb', sku: 'CHM-PHD2', price: 11.95, category: 'Chemicals', unit: 'each' },
